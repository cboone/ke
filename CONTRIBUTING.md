...
Thank you for your interest in contributing to ke.

Please note that this project has a [Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold it.

## Reporting Issues

- **Bug reports and feature requests:** Use the [issue tracker](https://github.com/cboone/ke/issues/new/choose)
- **Questions and ideas:** Use [GitHub Discussions](https://github.com/cboone/ke/discussions)
...
- cargo-deny, cargo-audit, cargo-nextest (optional, for full CI parity)

### Getting Started

```bash
# Clone the repository
git clone https://github.com/cboone/ke.git
cd ke
